...
1. Let's implement a simple bank account! It's simplified (we're not using account numbers here)
...
function reducer (state, action) {
  ...
  case "openAccount":
    ...
    case "payLoan":
        return {
          ...state,
          loan: state.loan === 5000 && state.balance >= 5000 ? state.loan - 5000 : state.loan,
          balance: state.loan === 5000 && state.balance >= 5000 ? state.balance - 5000 : state.balance,
        }
    case "closeAccount":
      return{
        ...state,
